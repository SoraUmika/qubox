...
|--------------|-------------|-----------|
| `calibration/orchestrator.py` | `qubox_v2/tests/test_calibration_fixes.py` | Unit |
| `calibration/patch_rules.py` | `qubox_v2/tests/test_calibration_fixes.py` | Unit |
| `calibration/*` | `qubox_v2/tests/test_calibration_cqed_params.py` | Integration |
| `core/session_state.py` | `qubox_v2/tests/test_workflow_safety_refactor.py` | Unit |
| `core/persistence_policy.py` | `qubox_v2/tests/test_workflow_safety_refactor.py` | Unit |
| `core/bindings.py` | `qubox_v2/tests/test_parameter_resolution_policy.py` | Unit |

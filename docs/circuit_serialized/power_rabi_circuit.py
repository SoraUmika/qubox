...
# Single QUA script generated at 2026-04-03 20:16:11.394446
...
with program() as prog:
    ...
    v3 = declare(fixed, )
    v4 = declare(fixed, )
    with for_(v2,0,(v2<64),(v2+1)):
        with for_(v1,-0.15,(v1<0.17500000000000004),(v1+0.05)):
            play("x180"*amp(v1), "transmon", duration=4)
            align("transmon", "resonator")
    ...
    with stream_processing():
        r1.buffer(7).average().save("I")
        r2.buffer(7).average().save("Q")
        r3.save("iteration")

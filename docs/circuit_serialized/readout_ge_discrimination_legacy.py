...
# Single QUA script generated at 2026-04-03 20:16:11.858613
...
with program() as prog:
    ...
    with for_(v1,0,(v1<2048),(v1+1)):
        measure("readout", "resonator", dual_demod.full("cos", "sin", v2), dual_demod.full("minus_sin", "cos", v3))
        align()
        wait(250000, "resonator")
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)

...
# Single QUA script generated at 2026-04-03 20:16:11.587323
...
with program() as prog:
    ...
    with for_(v2,0,(v2<64),(v2+1)):
        with for_(v1,0.92,(v1<=0.92),(v1+1)):
            play("x180"*amp(v1), "transmon", duration=16)

"""Analysis namespace — pipelines, fitting, attributes, and plotting.

New analysis code should import from ``qubox_tools``.  Runtime/experiment
code uses the wrappers and ``cQED_attributes`` provided here.
"""

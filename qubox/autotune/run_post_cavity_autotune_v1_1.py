    ...
    writer.append_journal(
        {
            ...
            "code_path": "qubox.autotune.run_post_cavity_autotune_v1_1",
                ...
                writer.append_journal(
                    {
                        ...
                        "code_path": "qubox.experiments.session.SessionManager",
                        "decision": "continue",
        ...
        writer.append_journal(
            {
                ...
                "code_path": "qubox.autotune.run_post_cavity_autotune_v1_1._seed_session_state",
                "snapshot_hash": _snapshot_hash(attr),
                "element_aliases": {
                    "ro_el": getattr(attr, "ro_el", REFERENCE_SEED["ro_el"]),
                    "qb_el": getattr(attr, "qb_el", REFERENCE_SEED["qb_el"]),
                ...
                writer.append_journal(
                    {
                        ...
                        "code_path": "qubox.hardware.controller.HardwareController.calibrate_element",
                        "snapshot_hash": _snapshot_hash(attr),

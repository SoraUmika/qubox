...
class DisplacementTemplate(GateTemplate):
    ...
    def build(self, x_slice: np.ndarray, *, ctx: Any, n_max: int) -> List[Any]:
        try:
            from qubox.legacy.gates.models import DisplacementModel
...
class SQRTemplate(GateTemplate):
    ...
    def build(self, x_slice: np.ndarray, *, ctx: Any, n_max: int) -> List[Any]:
        ...
        try:
            from qubox.legacy.gates.models import SQRModel
        except Exception as e:
...
class QubitRotationTemplate(GateTemplate):
    ...
    def build(self, x_slice: np.ndarray, *, ctx: Any, n_max: int) -> List[Any]:
        try:
            from qubox.legacy.gates.models import QubitRotationModel
        except Exception as e:
...
class SNAPTemplate(GateTemplate):
    ...
    def build(self, x_slice: np.ndarray, *, ctx: Any, n_max: int) -> List[Any]:
        ...
        try:
            from qubox.legacy.gates.models import SNAPModel
        except Exception as e:

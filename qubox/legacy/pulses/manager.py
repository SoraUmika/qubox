...
class PulseOperationManager:
    ...
    # â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    #  Public add-helpers  (persist = True âžœ permanent store)
    # â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    def add_waveform(
        self,
        name: str,
    ...
    def add_digital_waveform(
        ...
        *samples* must be a list of (value, duration_cc) with value âˆˆ {0,1}.
        """
    ...
    def add_operation(self, op_id: str, pulse_name: str):
        """
        Register or overwrite the global mapping  op_id â†’ pulse_name.
        """
    ...
    def register_pulse_op(
        ...
        *,
        ...
        # and keep mapping 'cos','sin','minus_sin' â†’ reserved readout_* weights.
        ...
        if is_canonical_readout:
            ...
            if use_stemless:
                # â€œreadout-likeâ€ measurement pulses that are *not* the canonical one
    ...
    def modify_waveform(
        ...
        *,
        ...
        # Helper: decide whether new_samples is â€œscalar-likeâ€ or â€œarray-likeâ€
        try:
    ...
    def _default_iw_names_stemless() -> dict[str, str]:
        """Triplet without length suffix: cos/sin/minus_sin â†’ *_weights."""
        return {
            "cos":       "cos_weights",
            "sin":       "sin_weights",
            "minus_sin": "minus_sin_weights",
    ...
    def display_pulse(
        ...
        *,
        ...
        time_window : (int, int) or None, optional
            ...
            By convention, z[0] â†” t=1. The window is applied to both plots and to the FFT.
...
def build_pulse_operation_manager_from_config(
    ...
    Raises
    ------
    ValueError â€“ on any structural inconsistency.
    """
    if mgr_cls is None:
    ...
    # â”€â”€ 1) Waveforms â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ 1b) Digital waveforms â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ 2) Integration weights â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ 3) Pulses â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    for p_id, p in pls.items():
        ...
        # measurement â†’ validate int-weights
    ...
    # â”€â”€ 4) Element-specific operation maps â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    perm.el_ops.clear()

...
class sequenceMacros:
    ...
    def prepare_state(
        ...
        **prep_kwargs,
        ...
        r180 : str
            Name of the π pulse used for conditional resets.
        qb_el : str
            Qubit element name.
        max_trials : int
            Maximum number of prepare–measure attempts.
        targets : list | None
        ...
        **prep_kwargs :
        ...
        with while_((~done) & (tries < max_trials)):
            # Conditional π to move toward target_state
            if ts == "e":
        ...
        # ---- BLOBS ---- (inline geometry, no declares)
            ...
            if extend_halfplane:
                if extend_mode == "threshold":
                    ...
                    # default: "circle_edge" — use the x-extent of the opposite blob

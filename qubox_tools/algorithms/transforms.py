...
try:
    ...
    class unit:  # type: ignore[override]
        """Deferred fallback used when qualang_tools is unavailable."""

        def demod2volts(self, *_args, **_kwargs):
            raise ImportError("qualang_tools is required for demod2volts conversion.")
...
from .core import optimal_threshold_empirical, estimate_intrinsic_sigmas_mog

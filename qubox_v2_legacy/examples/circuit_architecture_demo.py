...
from ..programs.circuit_execution import run_compiled_circuit
from ..programs.circuit_protocols import EchoProtocol, RamseyProtocol
    ...
    *,
    ...
    for circuit in circuits:
        ...
        if output_dir is not None:
            ...
            fig.savefig(output_dir / f"{circuit.name}_diagram.png")
